...
<div id="event-create-container" class="col-md-6 offset-md-3">
    ...
    @method('PUT')
        ...
        <div class="form-group"><label for="date">Data do Evento:</label>
            <label for="date">Data do evento:</label>
            <input type="date" class="form-control" id="date" name="date" value="{{ strtotime($event->date) ? date('Y-m-d', strtotime($event->date)) : '' }}">
        </div>
